...
#pragma warning restore 0414
		...
		protected void UpdateEyeMatrices()
		{
			...
			bool isVrActive = UnityEngine.XR.XRSettings.enabled;
			bool isHeadsetActive = UnityEngine.XR.XRSettings.isDeviceActive;
#else
    bool isVrActive = UnityEngine.VR.VRSettings.enabled;
    bool isHeadsetActive = UnityEngine.VR.VRSettings.isDeviceActive;
#endif

			bool isStereoEnabled = Camera.main.stereoEnabled;

			if (isVrActive && isHeadsetActive && isStereoEnabled)
			{
