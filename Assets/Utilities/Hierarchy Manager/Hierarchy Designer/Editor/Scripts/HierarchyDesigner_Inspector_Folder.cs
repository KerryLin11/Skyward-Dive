...
namespace Verpha.HierarchyDesigner
{
    ...
    public class HierarchyDesigner_Inspector_Folder : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            if (contentBackgroundGUIStyle == null)
            {
                contentBackgroundGUIStyle = HierarchyDesigner_Shared_GUI.CreateCustomStyle(2, new RectOffset(2, 2, 2, 2), new RectOffset(4, 4, 4, 4));
            }
